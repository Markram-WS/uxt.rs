...
#[allow(dead_code)]
pub async fn get_opened_order<'a>(payload: Params<'a>)  -> Result< Vec<Order>, Box<dyn Error>> {
    ...
    let url = format!("{}/api/v3/openOrders?{}&signature={}", api_endpoint, query_string, signature);
